<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditPublications.ascx.cs"
    Inherits="Profiles.Edit.Modules.EditPublications.EditPublications" EnableViewState="true" %>
                    ...
                    <td>
                        ...
                        <div style="padding-left: 0px;">
                            <asp:GridView BorderStyle="Solid" ID="grdEditPublications" runat="server" AutoGenerateColumns="False"
                                GridLines="none" CellSpacing="-1" HorizontalAlign="Left" EmptyDataText="None"
                        ...
                        <asp:SqlDataSource ID="PublicationDS" runat="server" ConnectionString="<%$ ConnectionStrings:ProfilesDB %>"
                            SelectCommand="[Module.Edit].[Person.GetPublications]" SelectCommandType="StoredProcedure"
