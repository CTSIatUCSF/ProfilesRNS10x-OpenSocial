...
namespace Profiles.Edit.Modules.EditPublications
{
    public partial class EditPublications : BaseModule
    {
        ...
        public EditPublications(XmlDocument pagedata, List<ModuleParams> moduleparams, XmlNamespaceManager pagenamespaces)
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            litBackLink.Text = "<a href='" + Root.Domain + "/display/" + _subject + "'>Back to Profile</a> &gt; <a href='" + Root.Domain + "/edit/" + _subject + "'>Edit Menu</a>" + " &gt; <b>" + PropertyListXML.SelectSingleNode("PropertyList/PropertyGroup/Property/@Label").Value + "</b>";
