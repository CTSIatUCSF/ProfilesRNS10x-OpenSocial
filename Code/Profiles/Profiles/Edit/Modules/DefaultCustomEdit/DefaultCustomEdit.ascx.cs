...
namespace Profiles.Edit.Modules.DefaultCustomEdit
{
    public partial class DefaultCustomEdit : BaseModule
    {
        ...
        public DefaultCustomEdit() : base() { }
        public DefaultCustomEdit(XmlDocument pagedata, List<ModuleParams> moduleparams, XmlNamespaceManager pagenamespaces)
        ...
        private void DrawProfilesModule()
        {
            ...
            litBackLink.Text = "<a href='" + Root.Domain + "/display/" + this.SubjectID.ToString() + "'>Back to Profile</a> &gt; <a href='" + Root.Domain + "/edit/" + this.SubjectID.ToString() + "'>Edit Menu</a> &gt; <b>" + EntityName + "</b>";
