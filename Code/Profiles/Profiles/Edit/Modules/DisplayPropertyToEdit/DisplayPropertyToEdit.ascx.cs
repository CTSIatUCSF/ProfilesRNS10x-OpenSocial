...
namespace Profiles.Edit.Modules.DisplayPropertyToEdit
{
    public partial class DisplayPropertyToEdit : BaseModule
    {
        ...
        public DisplayPropertyToEdit() { }
        public DisplayPropertyToEdit(XmlDocument pagedata, List<ModuleParams> moduleparams, XmlNamespaceManager pagenamespaces)
            : base(pagedata, moduleparams, pagenamespaces)
        {
            ...
            litBackLink.Text = "<a href='" + Root.Domain + "/display/" + this.SubjectID + "'>Back to Profile</a> &gt; <a href='" + Root.Domain + "/edit/" + this.SubjectID + "'>Edit Menu</a> &gt; <b>" + PropertyListXML.SelectSingleNode("PropertyList/PropertyGroup/Property/@Label").Value + "</b>";
