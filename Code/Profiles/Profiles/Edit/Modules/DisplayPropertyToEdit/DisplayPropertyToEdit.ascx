<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DisplayPropertyToEdit.ascx.cs"
    Inherits="Profiles.Edit.Modules.DisplayPropertyToEdit.DisplayPropertyToEdit" %>
...
<asp:UpdatePanel ID="upnlEditSection" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <table id="tblEditProperty" width="100%">
            ...
            <tr>
                <td colspan="3">
                    <asp:Label ID="lblNoProperty" runat="server" Text="None" Font-Italic="true" ForeColor="#999"
                        Visible="false" />
                    ...
                    <asp:Panel ID="pnlInsertProperty" runat="server" Style="background-color: #F0F4F6;
                        ...
                        <table border="0" cellspacing="2" cellpadding="4">
                            <tr>
                                <td>
                                    <asp:TextBox ID="txtLabel" runat="server" Rows="25" Width="500px" TextMode="MultiLine"
                    ...
                    <div style="border-left: solid 1px #ccc;">
                        <asp:GridView ID="GridViewProperty" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            EmptyDataText="None" DataKeyNames="Subject,Predicate, Object" OnRowCancelingEdit="GridViewProperty_RowCancelingEdit"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtLabel" Rows="25" runat="server" TextMode="MultiLine" Width="500px"
