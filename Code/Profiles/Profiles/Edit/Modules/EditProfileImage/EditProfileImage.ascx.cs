...
namespace Profiles.Edit.Modules.EditProfileImage
{
    public partial class EditProfileImage : BaseModule
    {
        ...
        public EditProfileImage() : base() { }
        public EditProfileImage(XmlDocument pagedata, List<ModuleParams> moduleparams, XmlNamespaceManager pagenamespaces)
