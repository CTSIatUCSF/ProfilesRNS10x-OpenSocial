...
namespace Profiles.Edit.Modules.EditMailingAddress
{
    public partial class EditMailingAddress :  BaseModule
    {        
        ...
        public EditMailingAddress() : base() { }
        public EditMailingAddress(XmlDocument pagedata, List<ModuleParams> moduleparams, XmlNamespaceManager pagenamespaces)
            : base(pagedata, moduleparams, pagenamespaces)
        {
            ...
            litBackLink.Text = "<a href='" + Root.Domain + "/display/" + this.SubjectID.ToString() + "'>Back to Profile</a> &gt; <a href='" + Root.Domain + "/edit/" + this.SubjectID.ToString() + "'>Edit Menu</a> &gt; <b>" + PropertyListXML.SelectSingleNode("PropertyList/PropertyGroup/Property/@Label").Value + "</b>";
        ...
        private void DrawProfilesModule()
        {
            ...
            litMailingAddress.Text = Framework.Utilities.XslHelper.TransformInMemory(Server.MapPath("~/Edit/Modules/EditMailingAddress/EditMailingAddress.xslt"), args, base.BaseData.OuterXml);
