<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditAwardOrHonor.ascx.cs"
    Inherits="Profiles.Edit.Modules.EditAwardOrHonor.EditAwardOrHonor" %>
                ...
                <td>
                    ...
                    <div>
                        <asp:GridView ID="GridViewAwards" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            EmptyDataText="None" DataKeyNames="SubjectURI,Predicate, Object" GridLines="Both"
