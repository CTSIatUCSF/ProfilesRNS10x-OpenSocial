...
{
    public partial class GetTopSearchPhrase : BaseModule
    {
        ...
        public GetTopSearchPhrase() { }
        public GetTopSearchPhrase(XmlDocument pagedata, List<ModuleParams> moduleparams, XmlNamespaceManager pagenamespaces)
        ...
        private void DrawProfilesModule()
        {
            ...
            SqlDataReader reader = data.GetTopSearchPhrase(base.GetModuleParamString("TimePeriod"));
