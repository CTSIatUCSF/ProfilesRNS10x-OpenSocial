...
namespace Profiles.Search.Modules.EverythingPassiveResults
{
    public partial class EverythingPassiveResults : System.Web.UI.UserControl
    {
        ...
        public EverythingPassiveResults() : base() { }
        public EverythingPassiveResults(XmlDocument pagedata, List<ModuleParams> moduleparams, XmlNamespaceManager pagenamespaces)
        {
        ...
        private void DrawProfilesModule()
        {
            ...
            this.SearchResults = data.Search(data.SearchRequest(searchfor, "", "", "0", "100"));
            ...
            litEverythingPassiveResults.Text = XslHelper.TransformInMemory(Server.MapPath("~/Search/Modules/EverythingPassiveResults/EverythingPassiveResults.xslt"), args, this.SearchResults.OuterXml);
