...
namespace Profiles.Search.Modules.EverythingResults
{
    public partial class EverythingResults : BaseModule
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            DrawProfilesModule();
        }
        public EverythingResults() { }
        public EverythingResults(XmlDocument pagedata, List<ModuleParams> moduleparams, XmlNamespaceManager pagenamespaces)
        ...
        private void DrawProfilesModule()
        {
            ...
            try
            {
                ...
                this.SearchData = data.Search(xmlsearchrequest);
            ...
            {
                case "everything":
                    litEverythingResults.Text = XslHelper.TransformInMemory(Server.MapPath("~/Search/Modules/EverythingResults/EverythingResults.xslt"), args, this.SearchData.OuterXml);
                    break;
                case "people":
                    ...
                    litEverythingResults.Text = XslHelper.TransformInMemory(Server.MapPath("~/Search/Modules/EverythingResults/PeopleResults.xslt"), args, this.SearchData.OuterXml);
                    break;
            }
        }
