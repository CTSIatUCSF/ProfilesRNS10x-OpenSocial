...
namespace Profiles.Profile.Modules.SameDepartment
{
    public partial class SameDepartment : BaseModule
    {
        ...
        public SameDepartment() : base() { }
        public SameDepartment(XmlDocument pagedata, List<ModuleParams> moduleparams, XmlNamespaceManager pagenamespaces)
