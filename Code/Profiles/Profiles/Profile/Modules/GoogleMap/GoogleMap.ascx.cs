...
namespace Profiles.Profile.Modules.GeoMaps
{
    public partial class GoogleMap : BaseModule
    {
        ...
        public GoogleMap() { }
        public GoogleMap(XmlDocument data, List<ModuleParams> moduleparams, XmlNamespaceManager namespaces)
        ...
        public class GoogleMapHelper
        {
            ...
            //***************************************************************************************************************************************
            public Modules.GeoMaps.GoogleMap.GoogleMapLocation GetDefaultZoom()
            {
                Modules.GeoMaps.GoogleMap.GoogleMapLocation loc = null;
                Profiles.Profile.Utilities.DataIO data = new Profiles.Profile.Utilities.DataIO();


                loc = data.GetGoogleMapZoomLinks().Find(delegate(Modules.GeoMaps.GoogleMap.GoogleMapLocation item) { return item.DefaultLevel == "True"; });
