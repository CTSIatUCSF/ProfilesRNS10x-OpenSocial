...
{
    public partial class PersonPublications : BaseModule
    {
        ...
        public PersonPublications() : base() { }
        public PersonPublications(XmlDocument pagedata, List<ModuleParams> moduleparams, XmlNamespaceManager pagenamespaces)
