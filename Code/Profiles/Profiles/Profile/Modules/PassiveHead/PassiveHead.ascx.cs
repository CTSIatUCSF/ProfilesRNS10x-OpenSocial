...
namespace Profiles.Profile.Modules.PassiveHead
{
    public partial class PassiveHead : BaseModule
    {
        ...
        public PassiveHead() : base() { }
        public PassiveHead(XmlDocument pagedata, List<ModuleParams> moduleparams, XmlNamespaceManager pagenamespaces)
