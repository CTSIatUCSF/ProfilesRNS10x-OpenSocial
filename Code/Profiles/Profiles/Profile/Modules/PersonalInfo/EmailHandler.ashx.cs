    ...
    public class EmailHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (!string.IsNullOrEmpty(context.Request.QueryString["msg"]))
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT [Utility.Application].[fnDecryptBase64RC4] ( '" + email + "',   (Select [value] from [ontology.].parameter with(nolock) where ParameterID = 'RC4EncryptionKey'))");
