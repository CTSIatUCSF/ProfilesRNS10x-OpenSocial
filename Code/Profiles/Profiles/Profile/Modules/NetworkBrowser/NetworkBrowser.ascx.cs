...
namespace Profiles.Profile.Modules.NetworkBrowser
{
    public partial class NetworkBrowser : BaseModule
    {
        public NetworkBrowser() { }

        public NetworkBrowser(XmlDocument data, List<ModuleParams> moduleparams, XmlNamespaceManager namespaces)
        ...
        protected void InitAssets()
        {
            ...
            jsscript1.Attributes.Add("src", Root.Domain + "/Profile/Modules/NetworkBrowser/scriptaculous/lib/prototype.js");
            ...
            jsscript2.Attributes.Add("src", Root.Domain + "/Profile/Modules/NetworkBrowser/scriptaculous/src/scriptaculous.js");
            ...
            jsscript3.Attributes.Add("src", Root.Domain + "/Profile/Modules/NetworkBrowser/javascript/networkBrowserClass.js");
            ...
            divSwfScript.InnerHtml = "<script language=\"JavaScript\" type=\"text/javascript\"> " +
               ...
               "'width', '600'," +
               "'height', '600'," +
               "'src', '" + Root.Domain + "/profile/Modules/networkbrowser/network_browser.swf'," +
               "'movie', '" + Root.Domain + "/profile/Modules/networkbrowser/network_browser'," +
               "'quality', 'high'," +
           ...
           "</script>";
            ...
            script.InnerHtml = "window.onload = function() {" +
                " network_browser.Init('" + Root.Domain + "/profile/modules/networkbrowser/networkbrowsersvc.aspx?p='); " +
