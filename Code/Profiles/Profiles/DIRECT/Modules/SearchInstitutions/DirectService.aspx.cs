...
namespace Profiles.DIRECT.Modules.SearchInstitutions
{
    public partial class DirectService : System.Web.UI.Page
    {
        ...
        protected void DrawUIOnLoad()
        {
            ...
            string DirectServiceURL = Root.Domain + "/DIRECT/Modules/searchinstitutions/directservice.aspx";// Request.Url.AbsoluteUri.Replace("&", "&amp;");
            ...
            switch (task)
            {
                ...
                case "incomingcount":
                    ...
                    // Enter log record
                    sql = "insert into [Profile.Data].[Direct.LogIncoming](Details,ReceivedDate,RequestIP,QueryString) " +
                ...
                case "outgoingcount":
                    ...
                    for (int loop = 0; loop < ListOfThreads.Count; loop++)
                    {
                        ...
                        {
                            sql = "update [Profile.Data].[Direct.LogOutgoing] set ResponseTime = datediff(ms,SentDate,GetDate()), "
                                    + " ResponseState = " + 1
                ...
                case "outgoingdetails":
                    ...
                    {
                        // Enter log record
                        oDataIO.ExecuteSQLDataCommand("insert into [Profile.Data].[Direct.LogOutgoing](FSID,SiteID,Details,SentDate) "
    ...
    public class AsyncProcessing
    {
        ...
        public void BeginProcessRequest(Site site)
        {
            ...
            // Enter log record
            sql = "insert into [Profile.Data].[Direct.LogOutgoing](FSID,SiteID,Details,SentDate,QueryString) "
