...
namespace Profiles.Framework.Modules.CategoryList
{
    public partial class CategoryList :BaseModule
    {
        ...
        public CategoryList() { }
        public CategoryList(XmlDocument pagedata, List<ModuleParams> moduleparams, XmlNamespaceManager pagenamespaces)
        ...
        public void DrawProfilesModule()
        {
            ...
            litCategoryList.Text = Utilities.XslHelper.TransformInMemory(Server.MapPath("~/framework/modules/CategoryList/CategoryList.xslt"), args, document.OuterXml);            
