...
{
    public partial class DefaultMenu : BaseModule
    {
        ...
        public DefaultMenu(XmlDocument pagedata, List<ModuleParams> moduleparams, XmlNamespaceManager pagenamespaces)
        ...
        private void DrawProfilesModule()
        {
            ...
            if (data.GetSessionSecurityGroup() == -50)
                menulist.Append("<li><a href='" + Root.Domain + "/SPARQL/default.aspx'>SPARQL Query Tool</a></li>");
