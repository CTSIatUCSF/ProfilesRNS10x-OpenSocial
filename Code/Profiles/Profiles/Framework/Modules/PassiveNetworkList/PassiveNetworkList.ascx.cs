...
namespace Profiles.Framework.Modules.PassiveNetworkList
{
    public partial class PassiveNetworkList : BaseModule
    {
        ...
        public PassiveNetworkList() { }

        public PassiveNetworkList(XmlDocument pagedata, List<ModuleParams> moduleparams, XmlNamespaceManager pagenamespaces)
        ...
        public void DrawProfilesModule()
        {
            ...
            if (networkexists)
            {
                ...
                litPassiveNetworkList.Text = XslHelper.TransformInMemory(Server.MapPath("~/Framework/Modules/PassiveNetworkList/PassiveNetworkList.xslt"), args, document.OuterXml);
