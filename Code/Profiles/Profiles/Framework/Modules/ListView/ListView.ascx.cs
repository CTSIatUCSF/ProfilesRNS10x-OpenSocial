...
namespace Profiles.Framework.Modules.ListView
{
    public partial class ListView : BaseModule
    {
        ...
        public ListView() { }
        public ListView(XmlDocument pagedata, List<ModuleParams> moduleparams, XmlNamespaceManager pagenamespaces)
        ...
        public void DrawProfilesModule()
        {
            ...
            string xmlbuffer;
            if(base.GetModuleParamString("SortBy").Equals("Weight")) xmlbuffer = XslHelper.TransformInMemory(Server.MapPath("~/Framework/Modules/ListView/SortIntermediateByWeight.xslt"), args, document.OuterXml);
            else xmlbuffer = XslHelper.TransformInMemory(Server.MapPath("~/Framework/Modules/ListView/SortIntermediate.xslt"), args, document.OuterXml);
            litListView.Text = XslHelper.TransformInMemory(Server.MapPath("~/Framework/Modules/ListView/ListView.xslt"), args, xmlbuffer);
