<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PersonSearch.ascx.cs"
    Inherits="Profiles.Search.Modules.PersonSearch.PersonSearch" EnableViewState="true" %>
