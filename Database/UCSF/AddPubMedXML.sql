...
/****** Object:  StoredProcedure [Profile.Data].[Publication.Pubmed.AddPubMedXML]    Script Date: 12/20/2012 07:25:38 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	BEGIN CATCH
		...
		SELECT @ErrMsg = '[Profile.Data].[Publication.Pubmed.AddPubMedXML] FAILED WITH FOR ' + cast(@pmid as varchar) + ' : ' + ERROR_MESSAGE(),
