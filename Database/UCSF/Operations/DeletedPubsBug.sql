...
select * from [Profile.Data].[Publication.Person.Include] i join [Profile.Data].[Publication.Person.Exclude] e on i.PMID = e.pmid and i.personid = e.personid
where i.pmid is not null;

select * from [Profile.Data].[Publication.Person.Add]  a join [Profile.Data].[Publication.Person.Exclude] e on a.PMID = e.pmid and a.personid = e.personid
...
select distinct 'exec usp_DeletePublication ' + cast(i.personid as varchar) + ' , ''' + cast(i.pubid as varchar(50)) + ''';' from publications_include i join publications_exclude e on i.PMID = e.pmid and i.personid = e.personid
where i.pmid is not null;
